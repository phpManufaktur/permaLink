...
class permaLinkBackend extends permaLink {
  ...
  public function dlgList() {
    ...
    $SQL = sprintf("SELECT * FROM %s WHERE %s!='%s' ORDER BY %s ASC", $dbPermaLink->getTableName(), dbPermaLink::field_status, dbPermaLink::status_deleted, dbPermaLink::field_permanent_link);
    $links = array();
    ...
    foreach ($links as $link) {
      ...
      $links_array[$link[dbPermaLink::field_id]] = array(
        ...
        'edit_link' => sprintf('%s&%s', $this->page_link, http_build_query(array(
  ...
  public function dlgEdit() {
    ...
    $link_array = array(
      'id' => array(
        'name' => dbPermaLink::field_id,
        'value' => $link_id,
        'label' => pl_label_id,
        'hint' => pl_hint_id
      ),
      'request_type' => array(
        'name' => dbPermaLink::field_request_type,
      ...
      'request_by' => array(
        'name' => dbPermaLink::field_request_by,
      ...
      'request_call' => array(
        'name' => dbPermaLink::field_request_call,
      ...
      'timestamp' => array(
        'name' => dbPermaLink::field_timestamp,
